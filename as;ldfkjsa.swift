...
class ViewController: UIViewController {
	...
	*/
	...
	If we weren't entering a number before this
        ...
        And if the currentMode == .ERR, then clearHistory()
	...
	*/
    ...
    @IBAction func didTapBSpace(){
        ...
        if inputLine.text == "" || inputLine.text == "OVERFLOW" || inputLine.text == "ERR DIV 0" || inputLine.text == "CHOOSE NUM" || inputLine.text?.count == 1 {
